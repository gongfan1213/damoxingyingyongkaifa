...
nltk_data_path=os.path.join(root_path,"nltk_data")
...
LOCAL_RERANK_PATH = os.path.join(root_path,'bce-reranker-base_v1')
if os_system == 'Darwin':
...
LOCAL_EMBED_PATH = os.path.join(root_path,"bce-embedding-base_v1")
if os_system == 'Darwin':
